...
import { addPlayer, deletePlayer, editPlayer, getPlayer, getPlayerEvaluations, getPlayerGastos, getPlayers, searchPlayer, setPlayerAsProspecto, setPlayerStatus, topPlayers } from '../controllers/player.controller'
